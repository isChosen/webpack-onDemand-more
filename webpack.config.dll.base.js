/*
 * @Author: Detcx 
 * @Date: 2018-12-01 09:14:18 
 * @Last Modified by: Detcx
 * @Last Modified time: 2018-12-01 09:18:18
...
module.exports = {
  entry: {
    ...
    polyfill: ['core-js/fn/object/assign', 'core-js/fn/promise', 'whatwg-fetch'] // 将项目需要所有的 polyfill 放到一个单独的动态链接库中
  },
  output: {
