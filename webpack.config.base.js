/*
 * @Author: Detcx 
 * @Date: 2018-12-01 09:08:32 
 * @Last Modified by: Detcx
 * @Last Modified time: 2018-12-01 10:29:03
 * @Description: base
 */
...
module.exports = {
  ...
  plugins: [
    ...
    new CleanWebpackPlugin(['dist'], {exclude: ["dll", "cache"]}), // 清理时排除 dist/dll
    // 动态链接库
